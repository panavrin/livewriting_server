...
var insertDocument = function(db, data, callback) {
		data._id = mongoose.Types.ObjectId(aid);		   	db.collection('Articles').insertOne( data, function(err, result) {
		db.collection('Articles').insertOne( data, function(err, result) {				console.log("inserting: " + data.aid);
